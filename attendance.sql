...
INSERT INTO `checkreport` VALUES ('17', 'YQ', '永强', '2019-06-01 06:30', '2019-06-01 17:30', '正常');
...
INSERT INTO `checkreport` VALUES ('123', 'ZS', '张三', '2019-06-07 09:00', '2019-06-07 17:30', '迟到');
INSERT INTO `checkreport` VALUES ('125', 'LS', '李四', '2019-06-07 08:00', '2019-06-07 17:30', '正常');
INSERT INTO `checkreport` VALUES ('127', 'WEG', '王二狗', '2019-06-07 08:00', '2019-06-07 16:30', '早退');
INSERT INTO `checkreport` VALUES ('129', 'ZG', '赵构', '2019-06-07 08:00', '2019-06-07 17:30', '正常');
INSERT INTO `checkreport` VALUES ('131', 'CH', '翠花', '2019-06-07 08:00', '2019-06-07 12:30', '早退');
INSERT INTO `checkreport` VALUES ('133', 'LY', '刘英', '2019-06-07 08:00', null, '旷工');
...
CREATE TABLE `classes` (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_520_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `paysalary` (
  ...
  PRIMARY KEY (`Id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10023 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_520_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of paysalary
-- ----------------------------
INSERT INTO `paysalary` VALUES ('10001', '陈知心', '4000', '2019-06-01', '2019-06-30', '2019-07-01');
...
INSERT INTO `punchcard` VALUES ('17', '永强', '2019-06-01 06:30', null);
...
INSERT INTO `punchcard` VALUES ('123', '张三', '2019-06-07 09:00', null);
...
INSERT INTO `punchcard` VALUES ('128', '王二狗', '2019-06-07 16:30', null);
...
INSERT INTO `punchcard` VALUES ('132', '翠花', '2019-06-07 12:30', null);
...
-- Records of station
-- ----------------------------
INSERT INTO `station` VALUES ('101', 'ZC', '总裁', '总裁室', '101', '管理类', '管理公司');
INSERT INTO `station` VALUES ('201', 'HDKF', '后端开发', 'ZCS', '201', '技术类', '管理开发项目');
INSERT INTO `station` VALUES ('202', 'QDKF', '前端开发', 'ZCS', '202', '技术类', '前端开发');
INSERT INTO `station` VALUES ('301', 'CWRY', '财务人员', 'ZCS', '401', '文职类', '管理财务');
