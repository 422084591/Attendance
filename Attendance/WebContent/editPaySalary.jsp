						...
						<div id="main">
							...
							<s:if test="paySalary.id!=0">
								...
								<span class="kv-label"><label class="tsl"
									for="salariedMan">领薪人：</label> </span> <select
									name="salariedMan">
									<s:iterator value="employeesList" id="e">
										<option name="salariedMan"
							...
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="{领薪时间}">领薪时间：</label> </span> <input
									type="text" name="paidTime" class="text-align" id="time"
									placeholder="请输入派薪时间" autofocus size="25" title="领薪时间"
							...
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl" for="time">领薪区间：</label>
									...
									id="calculateStartDate" placeholder="请输入开始日期" autofocus
									size="25" title="开始日期"
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'calculateEndDate\')}'})"
									value='<s:property value="paySalary.calculateStartDate"/>'>
								<br> <input type="text" name="calculateEndDate"
									class="text-align" id="calculateEndDate" placeholder="请输入结束日期"
									autofocus size="25" title="结束日期"
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'calculateStartDate\')}'})"
