						...
						<div id="main">
							...
							<s:if test="station.stationId!=0">
								<div class="kv-item">
									...
									</span> <input readonly="readonly" type="text" name="stationId"
										class="text-align" id="Id" placeholder="*必填项" autofocus
										size="25" title="Id"
										value='<s:property value="station.stationId"/>'>
								</div>
							</s:if>
							<div class="kv-item">
								<span class="kv-label"><span style="color:red">*</span> <label class="tsl" for="number">岗位编码：</label>
								</span> <input type="text" name="stationCode" class="text-align"
									id="stationCode" placeholder="请输入岗位编码" autofocus size="25"
									title="岗位编码" value='<s:property value="station.stationCode"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color:red">*</span> <label class="tsl" for="name">岗位名称：</label>
								</span> <input type="text" name="stationName" class="text-align"
									id="stationName" placeholder="请输入岗位名称" size="25" title="岗位名称"
									value='<s:property value="station.stationName"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><label class="tsl" for="department">所在部门：</label>
								</span> 
							...
							<div class="kv-item">
								<span class="kv-label"><label class="tsl" for="immediateSuperior">直接上级：</label>
								</span>
							...
							<div class="kv-item">
								<span class="kv-label"><label class="tsl" for="stationCategory">岗位类别：</label>
								</span> <select name="stationCategory">						
							...
							<div class="kv-item">
								...
								</span> <input type="text" name="stationDescription" class="text-align"
									id="stationResponsibility" placeholder="请输入岗位职责" size="25" style="height: 100px;"
									title="岗位职责"
									value='<s:property value="station.stationDescription"/>'>
							</div>
							<div class="kv-item">
