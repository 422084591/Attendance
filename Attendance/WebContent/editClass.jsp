					...
					<div class="panel panel-default">
						...
						<div id="main">
								...
								<form name="personalForm" method="post" action="Classes_update">
									<div class="kv-item">
										<span class="kv-label"> <label class="tsl" for="ID">ID：</label>
											...
											size="25" title="ID" value='<s:property value="classes.id"/>'>
									</div>
							</s:else>
							<div class="kv-item">
								<span class="kv-label"> <span style="color: red">*</span>
									<label class="tsl" for="number">班次编码：</label>
								</span> <input type="text" name="Code" class="text-align" id="number"
									placeholder="请输入班次编码" autofocus size="25" title="班次编码"
									value='<s:property value="classes.Code"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="name">班次名称：</label> </span> <input type="text"
							...
							<div class="kv-item">
								...
								</span> <input type="text" name="morningBusinessHours"
									class="text-align" id="morningBusinessHours"
									placeholder="请输入早上上班时间" size="25" title="早上上班时间"
									onClick="WdatePicker({dateFmt:'HH:mm',maxDate:'#F{$dp.$D(\'afternoonBusinessHours\')}'})"
									value='<s:property value="classes.morningBusinessHours"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><label class="tsl"
									for="afternoonBusinessHours">下午下班时间：</label> </span> <input
									type="text" name="afternoonBusinessHours" class="text-align"
									id="afternoonBusinessHours" placeholder="请输入下午下班时间" size="25"
									title="下午下班时间"
									onClick="WdatePicker({dateFmt:'HH:mm',minDate:'#F{$dp.$D(\'morningBusinessHours\')}'})"
							...
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl" for="remark">备注：</label>
									...
									placeholder="请输入备注" autofocus size="25" style="height: 100px;"
									title="备注" value='<s:property value="classes.remark"/>'>
							</div>
