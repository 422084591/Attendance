							...
							<form name="personalForm" method="post" action="PunchCard_add">
								<div class="kv-item">
									<span class="kv-label"><span style="color: red">*</span>
										<label class="tsl" for="punchCardMan">打卡人：</label> </span> <input
										type="text" name="punchCardMan" class="text-align"
										readonly="readonly" id="name" placeholder="请输入打卡人姓名" autofocus
										size="25" title="打卡人姓名" value="${sessionScope.User.username}">
								</div>
								<div class="kv-item">
									<span class="kv-label"><span style="color: red">*</span>
										<label class="tsl" for="punchCardDate">打卡时间：</label> </span> <input
										type="text" name="punchCardDate" class="text-align" id="time"
										placeholder="请输入打卡时间" autofocus size="25" title="打卡时间"
										readonly="readonly" value="<%=str_date%>" class="Wdate">
								</div>
								<div class="kv-item">
									<span class="kv-label"> <label class="tsl" for="remark">备注：</label>
									</span> <input type="text" name="remark" class="text-align"
										id="remark" placeholder="请输入备注" autofocus size="25"
