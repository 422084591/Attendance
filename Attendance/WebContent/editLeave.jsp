							...
							<s:else>
								<form name="personalForm" method="post" action="Leave_update">
									<div class="kv-item">
										...
										<input readonly="readonly" type="text" name="id" class="text-align" id="ID" placeholder="*必填项" autofocus size="25" title="ID" value='<s:property value="leave.id"/>'>
									</div>
							</s:else>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="pleaseDummyMan">请假人：</label> </span> 
									<input type="text" name="pleaseDummyMan" class="text-align" id="pleaseDummyMan" placeholder="请输入请假人" autofocus size="25" title="请假人" value='<s:property value="leave.pleaseDummyMan" />'>
							</div>
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl" for="time">请假时间：</label>
								</span> 
								<input type="text" name="startTime" class="text-align" id="startTime" placeholder="请输入开始日期" autofocus size="25" value='<s:property value="leave.startTime" />'	title="开始日" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',maxDate:'#F{$dp.$D(\'endTime\',{m:-30})}'})">
								...
								<br> 
								<input type="text" name="endTime" id="endTime" readonly="readonly" placeholder="请选择请假时长" autofocus size="25"	title="截止日" onClick="leave()" value='<s:property value="leave.endTime" />'	>
							</div>
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl"
									for="leaveReason">请假原因：</label>
								</span> 
								<input type="text" name="leaveReason" class="text-align" id="leaveReason" placeholder="请输入请假原因" autofocus size="25" style="height: 100px;" title="备注" value='<s:property value="leave.leaveReason"/>'>
							</div>
							<div class="kv-item">
