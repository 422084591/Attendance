					...
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu"><a class="active" href="javascript:;">
							...
							<ul class="sub">
								...
								<li><a class="active" href="RepairCard_limit"> 补卡单</a></li>
							...
							<s:if test="repairCard.id!=0">
								<div class="kv-item">
									<span class="kv-label"> <label class="tsl" for="ID">ID：</label>
										...
										size="25" title="Id"
										value='<s:property value="repairCard.id"/>'>
								</div>
							</s:if>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="repairCardMan">补卡人姓名：</label> </span>
								<input type="text" name="repairCradMan" class="text-align"
									placeholder="请输入补卡人姓名" autofocus size="25" title="补卡人姓名"
									value="${sessionScope.User.username}">
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="repairCardDate">补卡时间：</label> </span> <input type="text"
									name="repairCradDate" class="text-align" id="repairCardDate"
									placeholder="请输入补卡时间" autofocus size="25" title=补卡时间
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"
									value="<%=str_date%>">
							</div>
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl" for="repairCardReason">补卡原因：</label>
								</span> <input type="text" name="repairCradReason" class="text-align"
									id="repairCradReason" placeholder="请备注补卡原因" autofocus size="25"
									style="height: 100px;" title="补卡原因"
									value='<s:property value="repairCard.repairCradReason"/>'>
							</div>
							<div class="kv-item">
