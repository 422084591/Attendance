				...
				<div class="table-agile-info">
					<div class="panel panel-default">
						...
						<div id="main">
							...
							<s:else>
								<form name="personalForm" method="post" action="Department_update">
							</s:else>
							<s:if test="department.departmentID!=0">
								<div class="kv-item">
									<span class="kv-label"> <label class="tsl" for="ID">部门ID：</label>
									</span> 
									<input readonly="readonly" type="text" name="departmentID" class="text-align" id="ID" placeholder="*必填项" autofocus size="25" title="Emp_ID" value='<s:property value="department.departmentID"/>'>
								</div>
							</s:if>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="number">部门编码：</label> </span> 
									<input type="text" name="departmentCode" class="text-align" id="number" placeholder="请输入部门编码" autofocus size="25" title="部门编码" value='<s:property value="department.departmentCode"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="name">部门名称：</label> </span> 
									<input type="text" name="departmentName" class="text-align" id="name" placeholder="请输入部门名称" size="50" title="部门名称" value='<s:property value="department.departmentName"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><label class="tsl"
									for="departmentHead">部门负责人：</label> </span>
							...
							<div class="kv-item">
								...
								<input type="text" name="departmentResponsibility" class="text-align" id="duty" placeholder="请输入部门职责" size="25" title="部门职责" value='<s:property value="department.departmentResponsibility"/>'>
							</div>
									<div class="kv-item">
								<span class="kv-label"><label class="tsl"
							...
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl"
								 ...
								 <input type="text" name="remark" class="text-align" id="remark" placeholder="请输入备注" size="25" style="height: 100px;" title="备注" value='<s:property value="department.remark"/>'>
							</div>
							<div class="kv-item">
