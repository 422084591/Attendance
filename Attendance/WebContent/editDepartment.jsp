				...
				<div class="table-agile-info">
					<div class="panel panel-default">
						...
						<div id="main">
							...
							<div class="kv-item">
								<span class="kv-label"><span style="color:red">*</span> <label class="tsl" for="number">部门编码：</label>
								</span> <input type="text" name="departmentCode" class="text-align"
									id="number" placeholder="请输入部门编码" autofocus size="25" title="部门编码"
									value='<s:property value="department.departmentCode"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color:red">*</span> <label class="tsl" for="name">部门名称：</label>
								</span> <input type="text" name="departmentName" class="text-align"
									id="name" placeholder="请输入部门名称" size="50" title="部门名称"
									value='<s:property value="department.departmentName"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><label class="tsl" for="departmentHead">部门负责人：</label>
								</span> 
								<select name="departmentHead">
								<s:iterator value="employeesList" id="e">
									<option name="departmentHead" value='<s:property value="#e.name" />'>
							...
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl"
									for="higher-up">上级部门：</label>
								</span> <input type="text" name="superiorDepartmentId"
									class="text-align" id="higher-up" placeholder="请输入上级部门" size="25"
									title="上级部门"
									value='<s:property value="department.superiorDepartmentId"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"> <label class="tsl"
									for="higher-up">备注：</label>
								</span> <input type="text" name="remark"
									class="text-align" id="remark" placeholder="请输入备注" size="25" style="height: 100px;"
									title="备注"
