						...
						<div>
							<form action="CheckReport_search">
								<input type="text" name="searchName" size="20"
									placeholder="请输入员工姓名" value='<s:property value="searchName"/>'>
								<input type="text" name="searchFirstTime" class="text-align"
									value='<s:property value="searchFirstTime"/>' id="startTime"
									placeholder="开始日" autofocus size="20" title="开始日"
									onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endTime\')}'})">
								<input type="text" name="searchLastTime" class="text-align"
									value='<s:property value="searchLastTime"/>' id="endTime"
									placeholder="截止日" autofocus size="20" title="截止日"
