						...
						<div id="main">
							...
							<div class="kv-item">
								<span class="kv-label"> <span style="color: red">*</span>
									...
									id="number" placeholder="请输入员工编码" autofocus size="25"
									title="员工编码" value='<s:property value="employee.staffCode"/>'><span
									style="color: red">*</span> <label style="color: #CC3300"
									class="tsl" for="number">将会成为您唯一的登录名</label>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="name">姓名：</label> </span> <input type="text"
									name="name" class="text-align" id="name" placeholder="请输入姓名"
									size="25" title="姓名"
									value='<s:property value="employee.name"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="sex_boy">性别：</label> </span> <input
									type="radio" name="sex" id="sex_boy" value="男" checked>
								男 <input type="radio" name="sex" id="sex_girl" value="女">女
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="age">年龄：</label> </span> <input type="text"
									name="age" class="text-align" id="age" placeholder="请输入年龄"
									size="25" title="年龄" value='<s:property value="employee.age"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="national">民族：</label> </span> <input
									type="text" name="nation" class="text-align" id="national"
									placeholder="请输入民族" size="25" title="民族"
									value='<s:property value="employee.nation"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="IDcard">身份证：</label> </span> <input
									type="text" name="idNumber" class="text-align" id="IDcard"
									placeholder="请输入身份证" size="25" title="身份证"
							...
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="emergencyContact">联系电话：</label> </span> <input
									type="text" name="phone" class="text-align"
									id="emergencyContact" placeholder="请输入联系电话" size="25"
									title="联系电话" value='<s:property value="employee.phone"/>'>
							</div>
							<div class="kv-item">
								<span class="kv-label"><span style="color: red">*</span>
									<label class="tsl" for="emergencyContactNumber">紧急联系人：</label>
								</span> <input type="text" name="emergencyContact" class="text-align"
									id="emergencyContactNumber" placeholder="请输入紧急联系人" size="25"
									title="紧急联系人"
							...
							<div class="kv-item">
								...
								</span> <input type="text" name="individualDescription"
									class="text-align" id="individualDescription"
									placeholder="请输入个人描述" autofocus size="25"
